...
It is possible to improve "warm up" time of restarted and new Document Engine pods by enabling persistent local cache.
...
| [`persistence.mountPath`](./values.yaml#L521) | Mount path inside the container | `"/data"` |
